...
os.getcwd()
DATA_DIR = '/Users/j-macbookpro2/Documents/Penn State Coursework/CYBER 362/Data Files/trec07p/data'
LABELS_FILE = '/Users/j-macbookpro2/Documents/Penn State Coursework/CYBER 362/Data Files/trec07p/full/index'
...
ann.fit(X_train_vector, y_train)
y_pred = ann.predict(X_test_vector)
